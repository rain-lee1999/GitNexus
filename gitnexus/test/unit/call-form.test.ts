...
const kotlinGrammar = (): TreeSitterLanguage =>
  getLanguageGrammar(SupportedLanguages.Kotlin) as TreeSitterLanguage;
const kotlinSuite = describe.skipIf(!kotlinAvailable);
