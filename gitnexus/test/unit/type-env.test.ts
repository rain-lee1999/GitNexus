...
const Kotlin = kotlinAvailable ? getLanguageGrammar(SupportedLanguages.Kotlin) : null;
...
const describeKotlin = describe.skipIf(!kotlinAvailable);
const itKotlin = it.skipIf(!kotlinAvailable);
